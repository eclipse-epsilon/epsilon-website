...
- **Plumbing included:** You can use the [ANT Epsilon tasks](doc/workflow.md) to compose Epsilon programs into complex ANT, Maven and Gradle workflows. Programs executed in the same workflow can share models and even pass parameters to each other.
